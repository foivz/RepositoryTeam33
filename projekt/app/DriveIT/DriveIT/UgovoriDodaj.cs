    ...
    public partial class frmUgovoriDodaj : Form
    {
        ...
        private void btnNapraviKupoprodajni_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                var dobavljac1 = db.dobavljac.Where<dobavljac>(x => x.id_dobavljac == ugovor.dobavljac_iddobavljac).First<dobavljac>();

                PdfUgovor.KupoprodajniUgovorOdDobavljaca(vozilo1, dobavljac1, ugovor);
